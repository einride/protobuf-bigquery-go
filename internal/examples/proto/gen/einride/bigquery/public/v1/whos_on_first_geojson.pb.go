...
type WhosOnFirstGeoJson struct {
	...
	Body                  *_struct.Struct      `protobuf:"bytes,3,opt,name=body,proto3" json:"body,omitempty"`                                                                  // STRING NULLABLE
	...
	LastModifiedTimestamp *timestamp.Timestamp `protobuf:"bytes,8,opt,name=last_modified_timestamp,json=lastModifiedTimestamp,proto3" json:"last_modified_timestamp,omitempty"` // TIMESTAMP NULLABLE
}
...
func (x *WhosOnFirstGeoJson) GetBody() *_struct.Struct {
	if x != nil {
		return x.Body
	}
	return nil
...
func (x *WhosOnFirstGeoJson) GetLastModifiedTimestamp() *timestamp.Timestamp {
	if x != nil {
...
var file_einride_bigquery_public_v1_whos_on_first_geojson_proto_rawDesc = []byte{
	...
	0x6d, 0x70, 0x42, 0x51, 0x5a, 0x4f, 0x67, 0x6f, 0x2e, 0x65, 0x69, 0x6e, 0x72, 0x69, 0x64, 0x65,
	0x2e, 0x74, 0x65, 0x63, 0x68, 0x2f, 0x69, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x2f, 0x65,
	...
	0x72, 0x79, 0x2f, 0x70, 0x75, 0x62, 0x6c, 0x69, 0x63, 0x2f, 0x76, 0x31, 0x3b, 0x70, 0x75, 0x62,
