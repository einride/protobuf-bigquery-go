...
type DogecoinTransaction struct {
	...
	BlockTimestamp      *timestamp.Timestamp `protobuf:"bytes,8,opt,name=block_timestamp,json=blockTimestamp,proto3" json:"block_timestamp,omitempty"`                  // TIMESTAMP REQUIRED
...
func (x *DogecoinTransaction) GetBlockTimestamp() *timestamp.Timestamp {
	if x != nil {
...
var file_einride_bigquery_public_v1_dogecoin_transaction_proto_rawDesc = []byte{
	...
	0x28, 0x09, 0x52, 0x09, 0x61, 0x64, 0x64, 0x72, 0x65, 0x73, 0x73, 0x65, 0x73, 0x42, 0x51, 0x5a,
	0x4f, 0x67, 0x6f, 0x2e, 0x65, 0x69, 0x6e, 0x72, 0x69, 0x64, 0x65, 0x2e, 0x74, 0x65, 0x63, 0x68,
	...
	0x72, 0x69, 0x64, 0x65, 0x2f, 0x62, 0x69, 0x67, 0x71, 0x75, 0x65, 0x72, 0x79, 0x2f, 0x70, 0x75,
